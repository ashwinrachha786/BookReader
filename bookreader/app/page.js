    ...
    <div className="flex flex-col h-screen justify-center items-center bg-gray-50">
      <div className="w-4/5 md:w-3/4 lg:w-1/2 xl:w-2/5 p-8 bg-white shadow-xl rounded-xl">
        ...
        <div className="p-4 bg-gray-100 rounded-lg mb-4">
          <p className="text-gray-700">Completion result: {completion}</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            id="user-input"
            type="text"
            className="w-full p-2 border border-gray-300 rounded shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200"
            value={input}
